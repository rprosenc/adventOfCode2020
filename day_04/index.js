...
XXrawData = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
//
// valid passports data
//

XXXrawData = `pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
function valid2(document) {
	hgt = document['hgt'];
	if (hgt == '158' ) {
		console.log(((hgt.match(/^\d*cm$/) && height >= 150 && height <= 193) || (hgt.match(/^\d*in$/) && height >= 59 && height <= 76)) ? 'true':'false');
	}
	for(i=0;i<requiredFields.length; i++) {
